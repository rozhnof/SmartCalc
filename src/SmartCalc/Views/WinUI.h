...
//        widgets->Window->setMinimumSize(420, 360);
    ...
    void SetStyleSheet(CalcWidgets *widgets) {
        ...
        digitButtons->SetButtonStyle("background-color: rgb(89, 40, 89);"
                                     "border-style: solid;"
                                     "border-width: 1px;"
        ...
        functionButtons->SetButtonStyle("background-color: rgb(119, 119, 56);"
                                     "border-style: solid;"
                                     "border-width: 1px;"
                                     "border-color: rgb(34, 34, 34);");
    ...
    void SetupUI(CreditCalcWidgets *widgets) override {
        widgets->label->setText("ЭТО КРЕДИТНЫЙ КАЛЬКУЛЯТОР НА ВИНДОВСЕ");
    }
