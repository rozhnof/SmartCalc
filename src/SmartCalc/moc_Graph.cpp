...
QT_MOC_LITERAL(6, 11), // "ChangeScope"
QT_MOC_LITERAL(18, 0), // ""
QT_MOC_LITERAL(19, 10), // "reDrawLine"
QT_MOC_LITERAL(30, 11), // "reDrawGraph"
QT_MOC_LITERAL(42, 8), // "SetStepX"
QT_MOC_LITERAL(51, 4) // "Show"

    },
    "Graph\0ChangeScope\0\0reDrawLine\0reDrawGraph\0"
    "SetStepX\0Show"
};
...
void Graph::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->ChangeScope(); break;
        case 1: _t->reDrawLine(); break;
        case 2: _t->reDrawGraph(); break;
        case 3: _t->SetStepX(); break;
...
const QMetaObject Graph::staticMetaObject = { {
    QMetaObject::SuperData::link<GraphUI::staticMetaObject>(),
...
void *Graph::qt_metacast(const char *_clname)
{
    ...
    return GraphUI::qt_metacast(_clname);
}

int Graph::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = GraphUI::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 5)
