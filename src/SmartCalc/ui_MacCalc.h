...
"}"));
        ...
        ButtonCloseBracket->setFont(font3);
...
"}"));
        ...
        ButtonFactorial->setGeometry(QRect(40, 150, 60, 84));
...
"}"));
        ...
        LabelInput->setGeometry(QRect(200, 70, 471, 29));
        QFont font5;
        font5.setPointSize(25);
        font5.setBold(true);
        LabelInput->setFont(font5);
        LabelInput->setStyleSheet(QString::fromUtf8("background-color: rgb(25, 25, 25);"));
