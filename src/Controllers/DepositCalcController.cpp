...
bool DepositCalcController::setInput(double depositAmount, double interestRate, bool interestCapitalization, double taxRate, QDate startDate, QDate endDate, QVector<QDate> paymentDays, std::multimap<QDate, double> topUpList, std::multimap<QDate, double> takeOffList) {
...
std::vector<Day> DepositCalcController::ConvertPeriod(QDate startDate, QDate endDate, QVector<QDate> paymentDays, std::multimap<QDate, double> topUpList, std::multimap<QDate, double> takeOffList) {
    std::vector<Day> days;
...
void DepositCalcController::Calculate() {
    _model.Calculate();
}
...
double DepositCalcController::getTaxAmount() {
...
std::vector<std::tuple<QDate, QString, double, double> > DepositCalcController::getGeneralList() {
