...
void ChartView::SetData(QVector<double> newBodyBar, QVector<double> newPercentBar) {
...
void ChartView::SetBorderBarColor(QColor bodyBorderBarColor, QColor percentBorderBarColor) {
    bodyBar->setBorderColor(bodyBorderBarColor);
    percentBar->setBorderColor(percentBorderBarColor);
}

void ChartView::SetLabelsColor(QColor color) {
...
void ChartView::SetBarWidth(qreal width) {
