...
CreditCalculatorUI::CreditCalculatorUI() : MainWindow(), _controller(new CreditCalcController), _widgets(new CreditCalcWidgets) {
...
void CreditCalculatorUI::SetupUI() {
...
void CreditCalculatorUI::AnnuityPayment() {
