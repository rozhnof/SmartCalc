...
QCheckBox *MainWindow::NewCheckBox(QWidget *parent, QString text,
                                   QString objectName) {
...
QLabel *MainWindow::NewLabel(QWidget *parent, QString text,
                             QString objectName) {
...
QDoubleSpinBox *MainWindow::NewDoubleSpinBox(QWidget *parent,
                                             QString objectName) {
...
QLineEdit *MainWindow::NewLineEdit(QWidget *parent, QString text,
                                   QString objectName) {
...
QPushButton *MainWindow::NewPushButton(QWidget *parent, QString text,
                                       QString objectName) {
...
QToolButton *MainWindow::NewToolButton(QWidget *parent, QString text,
                                       QString objectName) {
